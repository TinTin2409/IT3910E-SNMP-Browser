...
import org.example.core.SNMPManager;
...
public class SNMPBrowserUI extends JFrame {
    ...
    private void initializeUI() {
        ...
        backButton.addActionListener(e -> {
            if (!currentOidPath.isEmpty()) {
                ...
                List<Node> children = snmpManager.getChildrenOfOid(currentOidPath);
    ...
    private void loadMibsIntoList() {
        mibsListModel.clear();
        currentOidPath = "";
        java.util.List<Node> rootChildren = snmpManager.getChildrenOfOid("");
        updateMibsListWithChildren(rootChildren);
        backButton.setEnabled(false);
    }

    private void updateMibsListWithChildren(java.util.List<Node> children) {
        mibsListModel.clear();
    ...
    private void displayNodeDetails(String selectedNode, JTextArea detailArea) {
        ...
        if (node != null) {
            ...
            List<Node> children = snmpManager.getChildrenOfOid(oid);
            if (children.isEmpty()) {
